...
FOR %%G IN (islandvolcano, cityvolcano, islandsrest, island3big, oceanbottom_7, ocean_3, shallowwater5volcano, shallowwater4rest, shallowwater5rest, shallowwater43big, beachvolcano, wavevolcano, wave3big, waverest, treevolcano, beachrest, beach3big, treerest, tree3big, cloudboy_normal, cloudboy_slow, cloudboy_fast) DO (%ASSIMP% export %FROM%\3D\%%G.obj %TO%\3D\%%G.assxml)
...
%COPY% %FROM%\Cloud\Levels\Yun.xml %TO%\Cloud\Levels\Yun.xml
