...
FOR %%G IN (volcano.tga, volcano_beach.tga, city.tga, tree.tga, paw.tga, albino.tga, wet.tga, big.tga, pacman.tga, beach.tga, good.tga, ocean.tga, oceanbottom.tga, shallowwater.tga, cloud.tga) DO (%COPY% %FROM%\3D\%%G %TO%\3D\%%G)
